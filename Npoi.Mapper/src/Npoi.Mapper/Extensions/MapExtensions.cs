...
public static class MapExtensions
{
        ...
        Func<IColumnInfo, object, bool> tryPut = null)
    {
        ...
        var columnAttribute = new ColumnAttribute
        {
            ...
            TryTake = tryTake,
            Ignored = false,
        }.SetProperty(propertyInfo, propertyInfo.ReflectedType?.Name, propertyInfo.Name);
        ...
        Func<IColumnInfo, object, bool> tryPut = null)
    {
        ...
        var type = typeof(T);
        var (pi, fullPath) = MapHelper.GetPropertyInfo<T>(propertyName);
